...
> {
  ...
  /** Optional custom General step — renders instead of the default field-list GeneralStep when provided */
  GeneralStepComponent?: ComponentType<{ catalogItem: TItem | null }>;
